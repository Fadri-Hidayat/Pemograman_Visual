...
Public Class Customer
    ...
    Private Sub Reloaded()
        ...
        Dim data As List(Of classCustomer) = JsonConvert.DeserializeObject(Of List(Of classCustomer))(response)

        ' Bind the data to the DataGridView
        dgvData.DataSource = data
    End Sub

    Private Sub txtKodeCustomer_KeyDown(sender As Object, e As KeyEventArgs) Handles txtKodeCustomer.KeyDown
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(customer_api & "?kdcustomer=" & txtKodeCustomer.Text).Result
            ...
            If response.IsSuccessStatusCode Then
                ...
                Finally
                    If (customer_baru = False) Then
                        ...
                        Dim data As List(Of classCustomer) = JsonConvert.DeserializeObject(Of List(Of classCustomer))(jsonString)

                        ' Create textboxes dynamically and set their values
                        For Each mydata As classCustomer In data
                            txtKodeCustomer.Text = mydata.kdcustomer
                            txtNamaCustomer.Text = mydata.nama
                            txtJenisKelamin.Text = mydata.jk
    ...
    Private Sub TambahData()
        ...
        Dim nama As String = txtNamaCustomer.Text
        Dim jk As String = txtJenisKelamin.Text
        Dim telepon As String = txtTelepon.Text

        Dim postData As String = $"kdcustomer={kdcustomer}&nama={nama}&jk={jk}&telepon={telepon}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(customer_api & "?kdcustomer=" & txtKodeCustomer.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(customer_api & "?kdcustomer=" & txtKodeCustomer.Text, "DELETE", byteArray)
